...
- Latest progress: active no-CoVar baseline reached `11440/20000` at 2026-07-08 22:09 CST with `14` completed validations. Current best/latest mIoU is `0.5790` at the 11200-iter validation, with latest pixAcc `0.8918`. Current per-run ETA is about `1.27h`, estimating no-CoVar completion around 2026-07-08 23:25 CST.
- Runtime estimate: based on the current no-CoVar pace and Phase C 20k triage, expect remaining full four-variant queue time about `10.2-11.0h`; expected completion is around 2026-07-09 08:30-09:20 CST if uninterrupted.
