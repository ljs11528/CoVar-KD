...
- Latest progress: active no-CoVar baseline reached `8760/20000` at 2026-07-08 21:45 CST with `10` completed validations. Current best mIoU is `0.5366` at the 7200-iter validation; latest 8000-iter validation is mIoU `0.5009`, pixAcc `0.8691`. Current per-run ETA is about `1.65h`, estimating no-CoVar completion around 2026-07-08 23:25 CST.
- Runtime estimate: based on the current no-CoVar pace and Phase C 20k triage, expect remaining full four-variant queue time about `10.8-11.7h`; expected completion is around 2026-07-09 08:40-09:30 CST if uninterrupted.
